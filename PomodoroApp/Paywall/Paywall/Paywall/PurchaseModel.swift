...
class PurchaseModel: ObservableObject {
    ...
    init() {
        ...
        self.productIds = ["demo_lifetime", "demo_w"]
        self.productDetails = [
            PurchaseProductDetails(price: "$29.99", productId: "demo_lifetime", duration: "lifetime", durationPlanName: "Lifetime Plan", hasTrial: false),
